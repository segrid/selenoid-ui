...
.sessions__list {
  ...
  .session {
    ...
    .green-icon {
      filter: invert(35%) sepia(96%) saturate(6259%) hue-rotate(113deg) brightness(92%) contrast(104%);
    }

    .red-icon {
      filter: invert(11%) sepia(59%) saturate(7460%) hue-rotate(359deg) brightness(118%) contrast(118%);
    }
